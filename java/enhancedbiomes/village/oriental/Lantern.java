...
public class Lantern extends StructureVillagePiecesEB.Village
{
	public Lantern() {
	}

	public Lantern(StructureVillagePiecesEB.Start p_i2097_1_, int p_i2097_2_, Random p_i2097_3_, StructureBoundingBox p_i2097_4_, int p_i2097_5_) {
	...
	public boolean addComponentParts(World p_74875_1_, Random p_74875_2_, StructureBoundingBox p_74875_3_) {
		...
		this.placeBlockAtCurrentPosition(p_74875_1_, EnhancedBiomesBlocks.shojiLamp, 0, 0, p_74875_1_.getTopSolidOrLiquidBlock(this.getXWithOffset(0, 0), this.getZWithOffset(0, 0)) - this.boundingBox.minY, 0, p_74875_3_);
