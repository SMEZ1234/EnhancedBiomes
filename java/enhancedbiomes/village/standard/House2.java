...
public class House2 extends StructureVillagePiecesEB.Village
{
	...
	public House2(StructureVillagePiecesEB.Start p_i2103_1_, int p_i2103_2_, Random p_i2103_3_, StructureBoundingBox p_i2103_4_, int p_i2103_5_) {
		super(p_i2103_1_, p_i2103_2_);
		this.coordBaseMode = p_i2103_5_;
		this.boundingBox = p_i2103_4_;
	}

	public static House2 getPiece(StructureVillagePiecesEB.Start p_74915_0_, List p_74915_1_, Random p_74915_2_, int p_74915_3_, int p_74915_4_, int p_74915_5_, int p_74915_6_, int p_74915_7_) {
