...
public class MapGenRavineEnhancedBiomes extends MapGenBase
{
	...
	protected void func_151540_a(long p_151540_1_, int p_151540_3_, int p_151540_4_, Block[] p_151540_5_, byte[] metas, double p_151540_6_, double p_151540_8_, double p_151540_10_, float p_151540_12_, float p_151540_13_, float p_151540_14_, int p_151540_15_, int p_151540_16_, double p_151540_17_) {
								...
								if(d14 * d14 + d13 * d13 < 1.0D) {
									for(int l3 = i2 - 1; l3 >= i4; --l3) {
										...
										if((d14 * d14 + d13 * d13) * (double) this.field_75046_d[l3] + d11 * d11 / 6.0D < 1.0D) {
											...
											digBlock(p_151540_5_, metas, k3, k2, l3, j3, p_151540_3_, p_151540_4_, flag);
										}
	...
	protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_) {
		this.func_151538_a(p_151538_1_, p_151538_2_, p_151538_3_, p_151538_4_, p_151538_5_, p_151538_6_, new byte[p_151538_6_.length]);
	}

	protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_, byte[] metas) {
		if(this.rand.nextInt(50) == 0) {
			...
			for(int i1 = 0; i1 < b0; ++i1) {
				...
				this.func_151540_a(this.rand.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, metas, d0, d1, d2, f2, f, f1, 0, 0, 3.0D);
			}
		}
	}
		...
		if(block == Blocks.stone || block == EnhancedBiomesBlocks.stoneEB || block == filler || block == top)// || EnhancedBiomesBlocks.isGrass(block) || block == Blocks.dirt || block == EnhancedBiomesBlocks.dirtEB)
		{
			if(y < 10) {
				...
				if(foundTop && data[index - 1] == filler) {
					data[index - 1] = top;
					metas[index - 1] = top == EnhancedBiomesBlocks.grassEB ? EnhancedBiomesMod.grassMetaList[biome.biomeID] : (byte) (biome.field_150604_aj & 255);
				}
			}
		}
	}
