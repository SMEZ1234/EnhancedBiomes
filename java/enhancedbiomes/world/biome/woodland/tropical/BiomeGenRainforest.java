...
public class BiomeGenRainforest extends BiomeGenTropicalBase
{
	...
	public WorldGenAbstractTree func_150567_a(Random par1Random) {
		...
		(par1Random.nextInt(8) == 0 ? new WorldGenMegaJungle(false, 10, 20, 3, 3) : (par1Random.nextInt(6) == 0 ? TreeGen.fir_large(par1Random) : (par1Random.nextInt(4) == 0 ? TreeGen.fir(par1Random) : (par1Random.nextInt(2) == 0 ? new WorldGenSwamp() : new WorldGenTrees(true, 6, 3, 3, true)))));
	}
