...
{  	  	  	
	...
	public static void config()
	{
		...
		sandStoneRangesId = config.get(config.CATEGORY_GENERAL, "Biome ID of Sandstone Ranges", 68).getInt();
		...
		screeId = config.get(config.CATEGORY_GENERAL, "Biome ID of Scree", 69).getInt();
		villageScree = config.get(config.CATEGORY_GENERAL, "Generate villages in Scree biome", true).getBoolean(true);
		
		sandStoneCanyonId = config.get(config.CATEGORY_GENERAL, "Biome ID of Sandstone Canyon", 83).getInt();
		...
		sandStoneGorgeId = config.get(config.CATEGORY_GENERAL, "Biome ID of Sandstone Canyon 2", 84).getInt();
		...
		clayHillsId = config.get(config.CATEGORY_GENERAL, "Biome ID of Clay Hills", 86).getInt();
		...
		creekBedId = config.get(config.CATEGORY_GENERAL, "Biome ID of Creek Bed", 49).getInt();
		villageCreekBed = config.get(config.CATEGORY_GENERAL, "Generate villages in Creek Bed biome", true).getBoolean(true);

		sandStoneRangesMId = config.get(config.CATEGORY_GENERAL, "Biome ID of Sandstone Ranges M", 196).getInt();
