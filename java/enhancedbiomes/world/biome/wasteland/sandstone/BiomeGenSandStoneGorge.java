...
public class BiomeGenSandStoneGorge extends BiomeGenSandstoneBase
{
	private WorldGenerator theWorldGenerator;

	public BiomeGenSandStoneGorge(int par1) {
		super(par1);
	...
	public WorldGenAbstractTree func_150567_a(Random par1Random) {
		return (WorldGenAbstractTree) (par1Random.nextInt(3) == 0 ? TreeGen.birch() : TreeGen.eucalyptus_shrub(par1Random));
	}
