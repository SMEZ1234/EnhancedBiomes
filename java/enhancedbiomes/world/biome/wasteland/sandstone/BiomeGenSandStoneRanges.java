...
public class BiomeGenSandStoneRanges extends BiomeGenSandstoneBase
{
	...
	public WorldGenAbstractTree func_150567_a(Random par1Random) {
		return (WorldGenAbstractTree) (par1Random.nextInt(2) == 0 ? new WorldGenSpikedBush(Blocks.log, 0, Blocks.leaves, 0, EnhancedBiomesMod.soilList[biomeID]) : par1Random.nextInt(6) == 0 ? TreeGen.cypress(par1Random) : par1Random.nextInt(12) == 0 ? TreeGen.eucalyptus(par1Random) : TreeGen.eucalyptus_shrub(par1Random));
	}
