...
public class BiomeGenScree extends BiomeGenSandstoneBase
{
	private WorldGenerator theWorldGenerator;

	public BiomeGenScree(int par1) {
		super(par1);
	...
	public WorldGenAbstractTree func_150567_a(Random par1Random) {
		return (WorldGenAbstractTree) (par1Random.nextInt(4) == 0 ? new WorldGenSpikedBush(Blocks.log, 0, Blocks.leaves, 0, EnhancedBiomesMod.soilList[biomeID]) : par1Random.nextInt(4) == 0 ? TreeGen.cypress(par1Random) : par1Random.nextInt(8) == 0 ? TreeGen.eucalyptus(par1Random) : TreeGen.eucalyptus_shrub(par1Random));
	}
	...
	public void decorate(World par1World, Random par2Random, int par3, int par4) {
		...
		for(int c = 50; c > 0; c--) {
			...
			int l3 = 64 + par2Random.nextInt(64);
			int j5 = par4 + par2Random.nextInt(16) + 8;
			(new WorldGenMinableEnhancedBiomes(EnhancedBiomesMod.getCobbleFromStone(EnhancedBiomesMod.getDominantStone(j2, j5, par1World)), EnhancedBiomesMod.getDominantStoneMeta(j2, j5, par1World), 50, EnhancedBiomesMod.soilList[biomeID], true)).generate(par1World, par2Random, j2, l3, j5);
		}
