...
public class BiomeGenScree extends BiomeGenSandstoneBase
{
    ...
    {
        return (WorldGenAbstractTree)(par1Random.nextInt(4) == 0 ? 
        			new WorldGenSpikedBush(Blocks.log, 0, Blocks.leaves, 0, EnhancedBiomesMod.soilList[biomeID]) : par1Random.nextInt(4) == 0 ? 
        			TreeGen.cypress(par1Random) : par1Random.nextInt(8) == 0 ? 
