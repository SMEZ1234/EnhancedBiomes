...
public class WorldChunkManagerEB extends WorldChunkManager
{
	...
	protected WorldChunkManagerEB() {
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList();
	}

	public WorldChunkManagerEB(long par1, WorldType par3WorldType) {
		this();
	...
	public WorldChunkManagerEB(World par1World) {
