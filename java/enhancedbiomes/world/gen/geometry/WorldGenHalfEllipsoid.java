...
public class WorldGenHalfEllipsoid extends WorldGenerator
{
	...
	public WorldGenHalfEllipsoid(Block fill, int radius, float variation) {
		this.fillId = fill;
		this.radius = radius;
		this.variation = variation;
	}

	public WorldGenHalfEllipsoid(Block fill, int radius, float variation, int meta) {
		this.fillId = fill;
		this.radius = radius;
		this.fillMeta = meta;
		this.variation = variation;
	...
	public WorldGenHalfEllipsoid(Block fill, int radius, float variation, boolean exception, Block exceptionID) {
		this.fillId = fill;
		this.radius = radius;
