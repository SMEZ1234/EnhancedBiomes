...
public class WorldGenPool extends WorldGenerator
{
	...
	public WorldGenPool(Block par1, int par2) {
		this.liquidId = par1;
		this.numberOfBlocks = par2;
	}

	public WorldGenPool(Block id, int number, Block stoneId) {
		this(id, number);
						...
						if(var39 * var39 + var42 * var42 < 1.0D) {
							for(int var44 = var34; var44 <= var37; ++var44) {
								...
								if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && stone == this.stoneBlockId) {
									if(var41 == 62) {
										par1World.setBlock(var38, var41, var44, this.liquidId, 0, 2);

										if(par1World.getBlock(var38, var41 + 1, var44).isOpaqueCube() == false) {
											par1World.setBlock(var38, var41 + 1, var44, Blocks.air, 0, 2);
										}
									}
								}
							}
