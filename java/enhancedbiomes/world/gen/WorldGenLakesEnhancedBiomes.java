...
public class WorldGenLakesEnhancedBiomes extends WorldGenerator
{
	private Block blockIndex;
	private Block surroundID;

	public WorldGenLakesEnhancedBiomes(Block par1, Block par2) {
		this.blockIndex = par1;
		this.surroundID = par2;
	}
				...
				for(var32 = 0; var32 < 16; ++var32) {
					for(var10 = 0; var10 < 8; ++var10) {
						...
						if(var33) {
							...
							if(var10 < 4 && !var12.isSolid() && par1World.getBlock(par3 + var8, par4 + var10, par5 + var32) != this.blockIndex) {
								return false;
							}
						}
					}
				...
				for(var32 = 0; var32 < 16; ++var32) {
					for(var10 = 0; var10 < 8; ++var10) {
						if(var6[(var8 * 16 + var32) * 8 + var10]) {
							par1World.setBlock(par3 + var8, par4 + var10, par5 + var32, var10 >= 4 ? Blocks.air : this.blockIndex, 0, 2);
						}
					}
				}
			}
				...
				for(var8 = 0; var8 < 16; ++var8) {
					for(var32 = 0; var32 < 16; ++var32) {
						for(var10 = 0; var10 < 8; ++var10) {
							...
							if(var33 && (var10 < 4 || par2Random.nextInt(2) != 0) && par1World.getBlock(par3 + var8, par4 + var10, par5 + var32).isOpaqueCube()) {
								par1World.setBlock(par3 + var8, par4 + var10, par5 + var32, this.surroundID, 0, 2);
							}
						}
					}
				}
