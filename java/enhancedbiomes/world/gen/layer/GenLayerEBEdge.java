...
public class GenLayerEBEdge extends GenLayer
{
	private final GenLayerEBEdge.Mode field_151627_c;

	public GenLayerEBEdge(long p_i45474_1_, GenLayer p_i45474_3_, GenLayerEBEdge.Mode p_i45474_4_) {
		super(p_i45474_1_);
	...
	public int[] getInts(int par1, int par2, int par3, int par4) {
		switch(GenLayerEBEdge.SwitchMode.field_151642_a[this.field_151627_c.ordinal()]) {
			case 1:
			default:
	...
	{
		static final int[] field_151642_a = new int[GenLayerEBEdge.Mode.values().length];

		static {
			try {
				field_151642_a[GenLayerEBEdge.Mode.COOL_WARM.ordinal()] = 1;
			} catch(NoSuchFieldError var3) {
				;
			}

			try {
				field_151642_a[GenLayerEBEdge.Mode.HEAT_ICE.ordinal()] = 2;
			} catch(NoSuchFieldError var2) {
				;
			}

			try {
				field_151642_a[GenLayerEBEdge.Mode.SPECIAL.ordinal()] = 3;
