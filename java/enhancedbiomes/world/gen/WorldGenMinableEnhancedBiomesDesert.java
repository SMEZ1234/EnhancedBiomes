...
public class WorldGenMinableEnhancedBiomesDesert extends WorldGenerator
{
	...
	public WorldGenMinableEnhancedBiomesDesert(Block par1, int par2) {
		this.minableBlockId = par1;
		this.numberOfBlocks = par2;
	}

	public WorldGenMinableEnhancedBiomesDesert(Block id, int meta, int number, Block stoneId) {
		this(id, number);
		minableBlockMeta = meta;
		stoneBlockId = stoneId;
	}

	public WorldGenMinableEnhancedBiomesDesert(Block id, int meta, int number, Block stoneId, boolean topLayer) {
		this(id, number);
		minableBlockMeta = meta;
		stoneBlockId = stoneId;
