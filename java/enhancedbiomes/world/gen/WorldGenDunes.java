...
public class WorldGenDunes extends WorldGenerator
{
	int height = 4;
	int steep = 3;
	...
	public WorldGenDunes(BiomeGenBase bi, Block bl)
	{
		biome = bi;
		block = bl;
	}
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) 
	{
		...
		{
			if(var1.getBlock(var3, var1.getTopSolidOrLiquidBlock(var3, z) - 1, z) == block && 
