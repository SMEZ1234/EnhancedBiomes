...
public class WorldGenMinableEnhancedBiomes extends WorldGenerator
{
	...
	public WorldGenMinableEnhancedBiomes(Block par1, int par2) {
		this.minableBlockId = par1;
		this.numberOfBlocks = par2;
	}

	public WorldGenMinableEnhancedBiomes(Block id, int meta, int number, Block stoneId) {
		this(id, number);
		minableBlockMeta = meta;
		stoneBlockId = stoneId;
	}

	public WorldGenMinableEnhancedBiomes(Block id, int meta, int number, Block stoneId, boolean topLayer) {
		this(id, number);
		minableBlockMeta = meta;
		stoneBlockId = stoneId;
