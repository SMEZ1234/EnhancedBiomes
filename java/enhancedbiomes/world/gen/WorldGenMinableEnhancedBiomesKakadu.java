...
public class WorldGenMinableEnhancedBiomesKakadu extends WorldGenerator
{
	/** The block ID of the ore to be placed using this generator. */
	private Block minableBlockId;
	private int minableBlockMeta = 0;
	private Block stoneBlockId = Blocks.stone;
	private boolean topLayerOnly = false;

	/** The number of blocks to generate. */
	private int numberOfBlocks;

	public WorldGenMinableEnhancedBiomesKakadu(Block par1, int par2) {
		this.minableBlockId = par1;
		this.numberOfBlocks = par2;
	}

	public WorldGenMinableEnhancedBiomesKakadu(Block id, int meta, int number, Block stoneId) {
		this(id, number);
		minableBlockMeta = meta;
		stoneBlockId = stoneId;
	}

	public WorldGenMinableEnhancedBiomesKakadu(Block id, int meta, int number, Block stoneId, boolean topLayer) {
		this(id, number);
		minableBlockMeta = meta;
		stoneBlockId = stoneId;
		topLayerOnly = topLayer;
	}
					...
					for(int var41 = var33; var41 <= var36; ++var41) {
						...
						if(var39 * var39 + var42 * var42 < 1.0D) {
							for(int var44 = var34; var44 <= var37; ++var44) {
								...
								//Block block = Blocks.blocksList[par1World.getBlockId(var38, var41, var44)];
								Block stone = par1World.getBlock(var38, var41, var44);
								if(var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && (stone == this.stoneBlockId || stone == Blocks.dirt)) {
