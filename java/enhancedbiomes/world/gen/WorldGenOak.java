	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		for(int a = 0; a < roots / 2; a++) {
			...
			for(int b = 0; b < rootLength; b++) {
				...
				if(var1.getBlock(var3 - x, var4 - y, var5 - z) == Blocks.grass || var1.getBlock(var3 - x, var4 - y, var5 - z) == Blocks.dirt || var1.getBlock(var3 - x, var4 - y - 1, var5 - z) == Blocks.grass || var1.getBlock(var3 - x, var4 - y - 1, var5 - z) == Blocks.dirt) {
					var1.setBlock(var3 - x, var4 - y, var5 - z, this.woodId, this.woodMeta, 3);
				}
			}

			if(var1.getBlock(posX, posY, posZ) == Blocks.grass || var1.getBlock(posX, posY, posZ) == Blocks.dirt || var1.getBlock(posX, posY - 1, posZ) == Blocks.grass || var1.getBlock(posX, posY - 1, posZ) == Blocks.dirt) {
				var1.setBlock(posX, posY, posZ, this.woodId, this.woodMeta, 3);
			}
		}
