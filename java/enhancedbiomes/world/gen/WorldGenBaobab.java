...
public class WorldGenBaobab extends WorldGenAbstractTree
{
	...
	public boolean generate(World var1, Random var2, int var3, int var4, int var5) {
		...
		for(int i = 0; i < height; i++) {
			if(var1.getBlock(var3, var4 + i, var5) != Blocks.air || var1.getBlock(var3 + 1, var4 + i, var5) != Blocks.air || var1.getBlock(var3, var4 + i, var5 + 1) != Blocks.air || var1.getBlock(var3 + 1, var4 + i, var5 + 1) != Blocks.air) {
				return false;
			}
		}
