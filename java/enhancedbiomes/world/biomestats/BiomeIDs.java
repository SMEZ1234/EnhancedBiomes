...
public class BiomeIDs {
	...
	public static final int forestedArchipelago = getNextID();		public static final int floweryArchipelago = forestedArchipelago + 128;
	public static final int pineForestArchipelago = getNextID();	public static final int borealArchipelago = pineForestArchipelago + 128;
	public static final int polarDesert = getNextID();				public static final int iceSheet = polarDesert + 128;
	public static final int woodlands = getNextID();				public static final int forestedMountains = woodlands + 128;
	public static final int woodlandHills = getNextID();			public static final int forestedValley = woodlandHills + 128;
	public static final int cypressForest = getNextID();			public static final int coldCypressForest = cypressForest + 128;
	public static final int borealForest = getNextID();				public static final int coldBorealForest = borealForest + 128;
	public static final int volcano = getNextID();					public static final int volcanoM = volcano + 128;
	public static final int plateau = getNextID();					public static final int snowyPlateau = plateau + 128;
	public static final int sandstoneRanges = getNextID();			public static final int sandstoneRangesM = sandstoneRanges + 128;
	public static final int shrublands = getNextID();				public static final int roofedShrublands = shrublands + 128;
	public static final int meadow = getNextID();					public static final int meadowM = meadow + 128;
	public static final int alpineMountains = getNextID();			public static final int alpineMountainsM = alpineMountains + 128;
	public static final int tundra = getNextID();					public static final int snowyDesert = tundra + 128;
	...
	public static final int pineForest = getNextID();				public static final int coldPineForest = pineForest + 128;
