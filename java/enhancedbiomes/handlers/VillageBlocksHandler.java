	...
	public void setVillageBlock(BiomeEvent.GetVillageBlockID event) {
		...
		if(EnhancedBiomesMod.isStoneVillageList[bi]) {
			if(b == EnhancedBiomesRock.biomeBasin || b == EnhancedBiomesRock.biomeRockHills) {
				...
				else if(a == acacia_stairs || a == birch_stairs || a == dark_oak_stairs || a == jungle_stairs || a == oak_stairs || a == spruce_stairs) event.replacement = stone_stairs;
			}
			else {
			...
			if(wood == planksEB) {
				...
				else if(a == acacia_stairs || a == birch_stairs || a == dark_oak_stairs || a == jungle_stairs || a == oak_stairs || a == spruce_stairs) event.replacement = stairsEB[wmeta];
			}
			else if(wood == planks && wmeta <= 3) {
				if(a == log2) event.replacement = log;
				else if(a == acacia_stairs || a == birch_stairs || a == dark_oak_stairs || a == jungle_stairs || a == oak_stairs || a == spruce_stairs) {
