...
import enhancedbiomes.blocks.BlockOreEB;
...
public class RenderOreEB
{
	...
	public RenderOreEB(IBlockAccess blockAccess, RenderBlocks renderer) {
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block p_147751_1_, int p_147751_2_, int p_147751_3_, int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_) {
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_, 0)) {
			...
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceYNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
				renderer.renderFaceYNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getOverlay());
			}
			else renderer.renderFaceYNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getIcon(0, renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_, 1)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceYPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
				renderer.renderFaceYPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getOverlay());
			}
			else renderer.renderFaceYPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getIcon(1, renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1, 2)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
				renderer.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getOverlay());
			}
			else renderer.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getIcon(2, renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1, 3)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceZPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
				renderer.renderFaceZPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getOverlay());
			}
			else renderer.renderFaceZPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getIcon(3, renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_, 4)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceXNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
				renderer.renderFaceXNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getOverlay());
			}
			else renderer.renderFaceXNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getIcon(4, renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_, 5)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceXPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
				renderer.renderFaceXPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getOverlay());
			}
			else renderer.renderFaceXPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147751_2_, p_147751_3_, p_147751_4_)).getIcon(5, renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_)));
			flag = true;
		}
	...
	public boolean renderStandardBlockWithAmbientOcclusionPartial(Block p_147808_1_, int p_147808_2_, int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_) {
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_, 0)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceYNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
				renderer.renderFaceYNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getOverlay());
			}
			else renderer.renderFaceYNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getIcon(0, renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_ + 1, p_147808_4_, 1)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceYPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
				renderer.renderFaceYPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getOverlay());
			}
			else renderer.renderFaceYPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getIcon(1, renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1, 2)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceZNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
				renderer.renderFaceZNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getOverlay());
			}
			else renderer.renderFaceZNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getIcon(2, renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1, 3)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceZPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
				renderer.renderFaceZPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getOverlay());
			}
			else renderer.renderFaceZPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getIcon(3, renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_, 4)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceXNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
				renderer.renderFaceXNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getOverlay());
			}
			else renderer.renderFaceXNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getIcon(4, renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_, 5)) {
			...
			renderer.colorBlueTopRight *= f6;
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceXPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
				renderer.renderFaceXPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getOverlay());
			}
			else renderer.renderFaceXPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147808_2_, p_147808_3_, p_147808_4_)).getIcon(5, renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)));
			flag = true;
		}
	...
	public boolean renderStandardBlockWithColorMultiplier(Block p_147736_1_, int p_147736_2_, int p_147736_3_, int p_147736_4_, float p_147736_5_, float p_147736_6_, float p_147736_7_) {
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_, 0)) {
			...
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceYNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
				renderer.renderFaceYNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getOverlay());
			}
			else renderer.renderFaceYNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getIcon(0, renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_ + 1, p_147736_4_, 1)) {
			...
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceYPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
				renderer.renderFaceYPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getOverlay());
			}
			else renderer.renderFaceYPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getIcon(1, renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1, 2)) {
			...
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceZNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
				renderer.renderFaceZNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getOverlay());
			}
			else renderer.renderFaceZNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getIcon(2, renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ + 1, 3)) {
			...
			tessellator.setColorOpaque_F(f11, f14, f17);
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceZPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
				renderer.renderFaceZPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getOverlay());
			}
			else renderer.renderFaceZPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getIcon(3, renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_, 4)) {
			...
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceXNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
				renderer.renderFaceXNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getOverlay());
			}
			else renderer.renderFaceXNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getIcon(4, renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_ + 1, p_147736_3_, p_147736_4_, 5)) {
			...
			tessellator.setColorOpaque_F(f12, f15, f18);
			if(!renderer.hasOverrideBlockTexture()) {
				renderer.renderFaceXPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getStones(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
				renderer.renderFaceXPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getOverlay());
			}
			else renderer.renderFaceXPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, ((BlockOreEB) renderer.blockAccess.getBlock(p_147736_2_, p_147736_3_, p_147736_4_)).getIcon(5, renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_)));
			flag = true;
		}
	...
	public void renderBlockAsItem(Block block, int metadata, int i) {
		...
		if(isFancy) {
			renderer.renderFaceYNeg(block, 0, 0, 0, ((BlockOreEB) block).getStones(metadata));
			renderer.renderFaceYNeg(block, 0, 0, 0, ((BlockOreEB) block).getOverlay());
		}
		else {
			renderer.renderFaceYNeg(block, 0, 0, 0, ((BlockOreEB) block).getIcon(0, metadata));
		}
		tessellator.draw();
		tessellator.startDrawingQuads();
		tessellator.setNormal(0.0F, 1.0F, 0.0F);
		if(isFancy) {
			renderer.renderFaceYPos(block, 0, 0, 0, ((BlockOreEB) block).getStones(metadata));
			renderer.renderFaceYPos(block, 0, 0, 0, ((BlockOreEB) block).getOverlay());
		}
		else {
			renderer.renderFaceYPos(block, 0, 0, 0, ((BlockOreEB) block).getIcon(1, metadata));
		}
		tessellator.draw();
		tessellator.startDrawingQuads();
		tessellator.setNormal(0.0F, 0.0F, -1.0F);
		if(isFancy) {
			renderer.renderFaceZNeg(block, 0, 0, 0, ((BlockOreEB) block).getStones(metadata));
			renderer.renderFaceZNeg(block, 0, 0, 0, ((BlockOreEB) block).getOverlay());
		}
		else {
			renderer.renderFaceZNeg(block, 0, 0, 0, ((BlockOreEB) block).getIcon(2, metadata));
		}
		tessellator.draw();
		tessellator.startDrawingQuads();
		tessellator.setNormal(0.0F, 0.0F, 1.0F);
		if(isFancy) {
			renderer.renderFaceZPos(block, 0, 0, 0, ((BlockOreEB) block).getStones(metadata));
			renderer.renderFaceZPos(block, 0, 0, 0, ((BlockOreEB) block).getOverlay());
		}
		else {
			renderer.renderFaceZPos(block, 0, 0, 0, ((BlockOreEB) block).getIcon(3, metadata));
		}
		tessellator.draw();
		tessellator.startDrawingQuads();
		tessellator.setNormal(-1.0F, 0.0F, 0.0F);
		if(isFancy) {
			renderer.renderFaceXNeg(block, 0, 0, 0, ((BlockOreEB) block).getStones(metadata));
			renderer.renderFaceXNeg(block, 0, 0, 0, ((BlockOreEB) block).getOverlay());
		}
		else {
			renderer.renderFaceXNeg(block, 0, 0, 0, ((BlockOreEB) block).getIcon(4, metadata));
		}
		tessellator.draw();
		tessellator.startDrawingQuads();
		tessellator.setNormal(1.0F, 0.0F, 0.0F);
		if(isFancy) {
			renderer.renderFaceXPos(block, 0, 0, 0, ((BlockOreEB) block).getStones(metadata));
			renderer.renderFaceXPos(block, 0, 0, 0, ((BlockOreEB) block).getOverlay());
		}
		else {
			renderer.renderFaceXPos(block, 0, 0, 0, ((BlockOreEB) block).getIcon(5, metadata));
		}
		tessellator.draw();
		GL11.glTranslatef(0.5F, 0.5F, 0.5F);
	}
