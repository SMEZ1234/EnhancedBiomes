...
import enhancedbiomes.api.internal.BlockModOre;
...
public class RenderGrassEB
{
	RenderBlocks renderer;

	public RenderGrassEB(IBlockAccess blockAccess, RenderBlocks renderer) {
	 ...
	 */
	public boolean renderGrassBlock(Block p_147784_1_, int p_147784_2_, int p_147784_3_, int p_147784_4_) {
	...
	public boolean renderStandardBlockWithAmbientOcclusion(Block p_147751_1_, int p_147751_2_, int p_147751_3_, int p_147751_4_, float p_147751_5_, float p_147751_6_, float p_147751_7_) {
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_ - 1, p_147751_4_, 0)) {
			...
			renderer.renderFaceYNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, renderer.getBlockIcon(p_147751_1_, renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 0));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_ + 1, p_147751_4_, 1)) {
			...
			renderer.colorGreenTopRight *= f6;
			renderer.colorBlueTopRight *= f6;
			renderer.renderFaceYPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, renderer.getBlockIcon(p_147751_1_, renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_, 1));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ - 1, 2)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147751_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_));
			renderer.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.renderFaceZNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_, p_147751_3_, p_147751_4_ + 1, 3)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147751_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_));
			renderer.renderFaceZPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.colorBlueBottomRight *= p_147751_7_;
				renderer.colorBlueTopRight *= p_147751_7_;
				renderer.renderFaceZPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_ - 1, p_147751_3_, p_147751_4_, 4)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147751_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_));
			renderer.renderFaceXNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.colorBlueBottomRight *= p_147751_7_;
				renderer.colorBlueTopRight *= p_147751_7_;
				renderer.renderFaceXNeg(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147751_1_.shouldSideBeRendered(renderer.blockAccess, p_147751_2_ + 1, p_147751_3_, p_147751_4_, 5)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147751_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_));
			renderer.renderFaceXPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.colorBlueBottomRight *= p_147751_7_;
				renderer.colorBlueTopRight *= p_147751_7_;
				renderer.renderFaceXPos(p_147751_1_, (double) p_147751_2_, (double) p_147751_3_, (double) p_147751_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147751_2_, p_147751_3_, p_147751_4_))));
			}
	...
	public boolean renderStandardBlockWithAmbientOcclusionPartial(Block p_147808_1_, int p_147808_2_, int p_147808_3_, int p_147808_4_, float p_147808_5_, float p_147808_6_, float p_147808_7_) {
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_ - 1, p_147808_4_, 0)) {
			...
			renderer.colorGreenTopRight *= f6;
			renderer.colorBlueTopRight *= f6;
			renderer.renderFaceYNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, renderer.getBlockIcon(p_147808_1_, renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_, 0));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ - 1, 2)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147808_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_));
			renderer.renderFaceZNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.renderFaceZNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_, p_147808_3_, p_147808_4_ + 1, 3)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147808_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_));
			renderer.renderFaceZPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.colorBlueBottomRight *= p_147808_7_;
				renderer.colorBlueTopRight *= p_147808_7_;
				renderer.renderFaceZPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_ - 1, p_147808_3_, p_147808_4_, 4)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147808_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_));
			renderer.renderFaceXNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.colorBlueBottomRight *= p_147808_7_;
				renderer.colorBlueTopRight *= p_147808_7_;
				renderer.renderFaceXNeg(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147808_1_.shouldSideBeRendered(renderer.blockAccess, p_147808_2_ + 1, p_147808_3_, p_147808_4_, 5)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147808_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_));
			renderer.renderFaceXPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, iicon);
			...
			if(overlaying) {
				...
				renderer.colorBlueBottomRight *= p_147808_7_;
				renderer.colorBlueTopRight *= p_147808_7_;
				renderer.renderFaceXPos(p_147808_1_, (double) p_147808_2_, (double) p_147808_3_, (double) p_147808_4_, renderer.getIconSafe(renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147808_2_, p_147808_3_, p_147808_4_)))));
			}
	...
	public boolean renderStandardBlockWithColorMultiplier(Block p_147736_1_, int p_147736_2_, int p_147736_3_, int p_147736_4_, float p_147736_5_, float p_147736_6_, float p_147736_7_) {
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_ - 1, p_147736_4_, 0)) {
			...
			renderer.renderFaceYNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, renderer.getBlockIcon(p_147736_1_, renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_, 0));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_ + 1, p_147736_4_, 1)) {
			...
			renderer.renderFaceYPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, renderer.getBlockIcon(p_147736_1_, renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_, 1));
			flag = true;
		}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ - 1, 2)) {
			...
			overlaying = renderer.fancyGrass && iicon.getIconName().startsWith("enhancedbiomes:grass_") && !renderer.hasOverrideBlockTexture();
			if(overlaying) iicon = ((BlockGrassEB) p_147736_1_).getGrassUnderlayIcon(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_));
			...
			if(overlaying) {
				...
				renderer.renderFaceZNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_, p_147736_3_, p_147736_4_ + 1, 3)) {
			...
			if(overlaying) {
				tessellator.setColorOpaque_F(f11 * p_147736_5_, f14 * p_147736_6_, f17 * p_147736_7_);
				renderer.renderFaceZPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_ - 1, p_147736_3_, p_147736_4_, 4)) {
			...
			if(overlaying) {
				...
				renderer.renderFaceXNeg(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_))));
			}
		...
		if(renderer.renderAllFaces || p_147736_1_.shouldSideBeRendered(renderer.blockAccess, p_147736_2_ + 1, p_147736_3_, p_147736_4_, 5)) {
			...
			if(overlaying) {
				tessellator.setColorOpaque_F(f12 * p_147736_5_, f15 * p_147736_6_, f18 * p_147736_7_);
				renderer.renderFaceXPos(p_147736_1_, (double) p_147736_2_, (double) p_147736_3_, (double) p_147736_4_, renderer.getIconSafe(BlockGrassEB.getIconSideOverlay(renderer.blockAccess.getBlockMetadata(p_147736_2_, p_147736_3_, p_147736_4_))));
			}
